...
export const STR = {
  ...
  tapToHit: 'Drag the hammer · tap a nail to strike',
  howtoTitle: 'HOW TO PLAY',
  howtoBody: [
    'Drag your finger to move the hammer left and right.',
    'Tap right over a nail to swing the hammer and drive it down.',
    'Hit dead-center for a PERFECT strike — build combos for big scores!',
    'Off-center hits are weaker and can bend the nail.',
