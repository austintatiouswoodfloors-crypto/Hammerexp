  ...
  return (
    <div className="h-full sky-bg flex items-center justify-center px-6">
      <div className="w-full bg-white rounded-3xl shadow-2xl border-[3px] border-[#cfe8f8] p-7 text-center">
        <h2 className={`font-display font-extrabold text-3xl mb-1 ${win ? 'text-[#3fae6a]' : 'text-[#e06a5a]'}`}>
        ...
        <div className="bg-[#eef7fd] rounded-2xl p-4 mb-5">
          <div className="text-[#5a86a3] font-bold text-sm">{t.score}</div>
          <div className="font-display font-extrabold text-5xl text-[#37546a] leading-tight">{score}</div>
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <button onClick={onRetry}
            className="h-12 text-base font-bold rounded-2xl bg-white border-2 border-[#bfe0f5] text-[#4a7590] hover:bg-[#f2f9fe] active:scale-95 transition-transform flex items-center justify-center">
            <RotateCcw size={18} className="mr-1.5" /> {t.retry}
          </button>
